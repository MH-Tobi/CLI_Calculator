...
- not allowed:
  ...
  - `calculator calculate -- (2+4)*(3+2)` => Parenthesis Pairs for Encapsulating Expressions currently not allowed
...
- [ ] Detection of Parenthesis Pairs for Encapsulating Expressions
